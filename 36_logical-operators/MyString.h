#ifndef MY_STRING_H_AANANTH
#define MY_STRING_H_AANANTH
...
public : 
    ...
    bool operator!=(const string& right) {
        return (strcmp(this->m_data, right.m_data));
    }
...
inline bool operator!=(const string& left, const string& right) {
    return (strcmp(left.m_data, right.m_data));
}
